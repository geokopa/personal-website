  ...
  return (
    <div id="timeline" className=" bg-[#0a192f] pt-0 sm:pt-32 md:pt-16 px-6">
      <div className="max-w-[1000px] mx-auto flex flex-col justify-center sm:justify-center w-full h-full sm:h-screen sm:p-4">
        ...
        <div className="p-6 sm:p-4 overflow-y-auto">
          <ol className="relative border-s border-gray-200 dark:border-gray-700 bg-[#0a192f] p-6 sm:p-4">
            {ExperienceList.map((client: ExperienceItem) => {
              return (
                <li className="mb-8 ms-2" key={client.id}>
